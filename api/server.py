...
LEAGUE_URLS = {
    "premier": "https://www.stoiximan.gr/sport/podosfairo/diorganoseis/agglia/1/",
    "greek": "https://www.stoiximan.gr/sport/podosfairo/ellada/stoiximan-super-league/1636/"
}
...
def scrape_endpoint():
    ...
    if not league or league not in LEAGUE_URLS:
        return jsonify({"status": "error", "message": "Valid league parameter 'l' is required"}), 400
